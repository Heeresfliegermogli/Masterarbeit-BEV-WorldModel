...
# =============================================================================
#SBATCH --job-name=ego16d
#SBATCH --gres=gpu:a100:2
#SBATCH --cpus-per-task=44
#SBATCH --mem=500G
#SBATCH --time=22:00:00
#SBATCH --output=logs/ego16d_%j.out
...
LABELS=(state action)                          # GPU 0, 1
declare -A CFG=( [state]="config_ego_state.yaml" [action]="config_ego_action.yaml" )
declare -A CKDIR=( [state]="checkpoints/task16d/ego_state" [action]="checkpoints/task16d/ego_action" )
BASE_CFG="${CFG[state]}"
