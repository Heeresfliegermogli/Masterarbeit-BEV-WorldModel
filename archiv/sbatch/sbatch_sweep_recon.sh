...
#SBATCH --job-name=sweep_recon                 # <<< 16b.7 (IN DER DATEI -- nicht via CLI!)
#SBATCH --gres=gpu:a100:2                      # <<< 16b.7: 2 Werte (mse, smooth_l1) -> 1 Welle
#SBATCH --cpus-per-task=44                     # ~ NGPU x 22
...
# ==========================================================================
REGLER="recon_loss"                            # <<< 16b.7: TERM-1-Distanz (kategorial)
VALUES=(mse smooth_l1)                          # <<< 16b.7: MSE vs SmoothL1, sonst Baseline-Lambdas
