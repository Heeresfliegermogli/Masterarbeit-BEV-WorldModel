...
#SBATCH --job-name=sweep_lambda_mean           # <<< EDIT (pro Sweep, IN DER DATEI -- nicht via CLI!)
...
# ==========================================================================
REGLER="lambda_mean"                           # <<< EDIT pro Sweep (IN DER DATEI)
VALUES=(0 0.1 0.3)                             # <<< EDIT pro Sweep (Nullpunkt zuerst!)
