...
#   GPU0 det_minimal_s43:  smooth_l1 + lambda_std   (Seg-Sieger-Rezept)
#   GPU1 det_baseline_s43: 6-Term (mse/cos0.1/mean0.1/std1/ssim0.1)
...
# =============================================================================
#SBATCH --job-name=det20s43
#SBATCH --gres=gpu:a100:2
#SBATCH --cpus-per-task=64
#SBATCH --mem=750G
#SBATCH --time=34:00:00
#SBATCH --output=logs/det20s43_%j.out
...
LABELS=(det_minimal_s43 det_baseline_s43)             # GPU 0, 1
declare -A CFG=( [det_minimal_s43]="config_det_minimal_s43.yaml" [det_baseline_s43]="config_det_baseline_s43.yaml" )
BASE_CFG="${CFG[det_minimal_s43]}"
...
import pack_latents
cfg = T.load_config("config_det_minimal_s43.yaml", "cell")
...
echo "[done] Checkpoints unter checkpoints/task20/{det_minimal_s43,det_baseline_s43}/phase2/"
exit "$FAIL"
