...
# =============================================================================
#SBATCH --job-name=sweep22a
#SBATCH --gres=gpu:a100:2
#SBATCH --cpus-per-task=44
#SBATCH --mem=500G
#SBATCH --time=16:00:00
#SBATCH --output=logs/sweep22a_%j.out
...
echo "[stage] $(date +%T)"
python -u "$SHM_STAGING" --stage --config "${CFG[rare_w4]}" || { echo "FEHLER: Pre-Staging."; exit 1; }
