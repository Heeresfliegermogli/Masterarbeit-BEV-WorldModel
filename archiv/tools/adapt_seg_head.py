#!/usr/bin/env python3
# =============================================================================
# adapt_seg_head.py — Task 23.1: Decoder-Adaptation auf WM-Vorhersagen
# =============================================================================
...
# Sensor-Pipeline: Latents aus dem Task-23-Train-Dump, GT aus dem gepackten
...
# als Checkpoint-Ersatz nutzbar (23.2).
#
...
def main():
    ...
    ap.add_argument("--seed", type=int, default=42,
                    help="Task 27: Seed des Kopf-Trainings (Init+Shuffle)")
    args = ap.parse_args()
