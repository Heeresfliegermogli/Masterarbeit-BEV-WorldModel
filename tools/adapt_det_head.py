#!/usr/bin/env python3
# =============================================================================
# adapt_det_head.py — TransFusion-Kopf-Adaptation auf Weltmodell-Vorhersagen (Det-Strang)
# =============================================================================
# Erweiterungen gegenueber der ersten Trainer-Fassung:
...
#      Verteilungen, Ziel: Real-Malus (-0.026 mAP der v1) schliessen
...
#      (Protokoll wie bei der Weltmodell-Selektion)
# USAGE (Docker det_extract): python /output/adapt_det_head.py [--smoke]
# Ausgabe: /output/adapted_det/det_adapted_{best,last}.pth
# =============================================================================
import argparse
import pickle
import time
...
def main():
    ...
    ap.add_argument("--seed", type=int, default=42,
                    help="Seed des Kopf-Trainings (Init/Shuffle/Mix)")
    args = ap.parse_args()
